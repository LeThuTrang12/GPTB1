...
namespace GPTB1.Controllers
{
    public class StudentController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "StudentID,Studentname,Password")] Student student)
        {
            try
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "StudentID,Studentname,Password")] Student student)
        {
            if (ModelState.IsValid)
            {
